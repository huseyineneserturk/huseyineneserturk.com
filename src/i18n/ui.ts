...
export const ui = {
  tr: {
    ...
    "about.title": "Müellif Hakkında",
    "about.skills": "Hünerler",
    "about.timeline": "Vakanüvis — Kronik",
    "about.stack": "Teknoloji Cephaneliği",

    "projects.title": "Eserler Mecmuası",
    "projects.subtitle": "İnşa ettiğim projeler — kodun ve fikrin harmanı.",
  ...
  en: {
    ...
    "about.skills": "Crafts",
    "about.timeline": "The Chronicle",
    "about.stack": "Technology Arsenal",

    "projects.title": "Compendium of Works",
    "projects.subtitle": "Projects I have built — a blend of code and idea.",
